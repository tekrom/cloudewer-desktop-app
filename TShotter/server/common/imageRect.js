...
class Injector{
    ...
    initImage(){
        ...
        /*Ekran görüntüsü verilerini resim olarak göster*/
    ...
    onDrawImage () {
        ...
        //Yakınlaştırırken ve uzaklaştırırken koordinatları başlat
        const  zoomStart ={
            x: 0,
            y :0
        }
        ...
        document.addEventListener('mousemove', e => {
            ...
            if (isZoom) {
                ...
                //Değişiklikleri gerçek zamanlı olarak göster
